...
### 🔐 [ECC vs RSA: Cryptographic Efficiency Suite](https://github.com/roni2668/ECC-vs-RSA-Security-Analysis)
> A multi-dimensional 10-module research framework designed to profile the performance gap between ECC-P521 and RSA-4096 standards. The system utilizes a Python-based benchmarking engine to evaluate the "Security-Speed-Sustainability" triad. By integrating Scikit-Learn for integrity validation (Confusion Matrix) and psutil for deep resource profiling, the project proves that ECC achieves a 100% verification rate while reducing energy consumption by 70%.
